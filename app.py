...
from PIL import Image # this package is need to send the pic to gemini
st.title("Note sumamry and quiz Generator")
...
if pressed:
    ...
    if images and selected_option:
     ...
     with st.container(border=True):
        ...
        with st.container(border=True):
            with st.spinner("AI is writting.."):
    ...
    with st.container(border=True):
        ...
        with st.container(border=True):
            with st.spinner("Audio is generating..."):
